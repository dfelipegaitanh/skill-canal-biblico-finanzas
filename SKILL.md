...
- **Validación de Rutas e Incertidumbre:** Si la petición es ambigua, cargar *únicamente* `references/onboarding.md` y hacer UNA sola pregunta de clasificación.
- **Para Guiones:** Siempre cargar `references/guion-reglas-obligatorias.md` (+ módulo de formato) antes de redactar.
- **Algoritmo (Frecuencia):** Máximo 1 Short al día. Calentar cuenta antes de publicar.
- **Cierre:** Siempre proponer el siguiente paso lógico de producción.
