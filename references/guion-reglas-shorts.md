# Módulo Específico: Reglas para Shorts

Este módulo se carga **únicamente** cuando se va a redactar un guion para formato corto (Micro-Short o Short Estándar). **Depende directamente de `guion-reglas-obligatorias.md`.**

---

## 1. DECISIÓN DE FORMATO AUTOMÁTICA (La IA elige)
...
*Declaración obligatoria al usuario:* "Para este tema voy con [Formato] porque [Razón]. Si prefieres otro, dímelo."

---

## 2. EL ARSENAL DE GANCHOS (Hooks)

### ⛔ REGLA DE DISONANCIA ESPECÍFICA (Stop Stack Conceptual)
La disonancia bíblica (atacar una creencia) JAMÁS debe atacar un concepto abstracto o vago (ej. "oración", "prudencia", "fe"). Debe atacar **estrictamente una acción física o práctica diaria** del espectador (ej. "el diezmo", "decretar", "pactar", "sembrar").
...
## 3. ARQUITECTURA DE RETENCIÓN (Estructuras Estrictas)
